...
<p align="center">
  <a href="https://github.com/ROYCE-8425/quiz_study/blob/main/docs/development/build-from-source.md">Документация</a> |
  <a href="#быстрый-старт">Быстрый старт</a> |
  <a href="https://github.com/ROYCE-8425/quiz_study/discussions">Обсуждения</a> |
...
## Что такое Học cùng Royce?

Học cùng Royce - это **образовательная платформа с открытым исходным кодом на основе ИИ**, которая помогает студентам учиться более эффективно через персонализированный контент, интеллектуальное обучение и адаптивные оценки. Созданный для студентов, преподавателей и людей, учащихся всю жизнь, Học cùng Royce сочетает передовые технологии ИИ с проверенной наукой об обучении.

В отличие от традиционных образовательных платформ, которые фокусируются исключительно на доставке контента, или инструментов ИИ-репетиторства, которым не хватает комплексных функций обучения, Học cùng Royce предоставляет вам полную образовательную экосистему с 6 мощными функциями ИИ, полным набором инструментов для обучения и многоплатформенным доступом.

<p align="center">
  <img src=".github/screenshots/dashboard-home.png" alt="Học cùng Royce Dashboard" width="800">
  <br>
  <em>Обучающая панель Học cùng Royce на основе ИИ</em>
</p>
...
<p align="center">
  <img src=".github/screenshots/ai-chat.png" alt="Học cùng Royce AI-чат" width="800">
  <br>
...
## Почему Học cùng Royce? (Сравнение)

| Функция | Học cùng Royce | Quizlet | Anki | ChatGPT | Khan Academy |
|---------|-----------|---------|------|---------|--------------|
...
<p align="center">
  <img src=".github/screenshots/problem-solver.png" alt="Học cùng Royce Мультиагентное решение задач" width="800">
  <br>
...
Học cùng Royce - это **активно поддерживаемый** проект с растущим сообществом.
...
Học cùng Royce поддерживает 12 языков через i18next (фронтенд) и Easy Localization (мобильное):

- English, 日本語, 中文, 한국어, Español, Français, Deutsch, Português, العربية, বাংলা, हिन्दी, Русский

## 🚀 Почему стоит внести вклад в Học cùng Royce?

Học cùng Royce - это больше, чем просто еще один проект с открытым исходным кодом -- это возможность построить будущее образования на основе ИИ и сделать качественное обучение доступным для миллионов студентов по всему миру.
...
- 📝 [Исправьте опечатки или улучшите документацию](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Adocumentation)
- 🌍 [Добавьте переводы](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Ai18n) -- Мы поддерживаем 12 языков
- 🐛 [Исправьте простые баги](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)

**🟡 Средний уровень**
- 🔌 Добавьте новые инструменты или возможности агентов ИИ
- 📊 Улучшите панель аналитики и визуализации
- 🧪 [Напишите тесты](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Atesting)

**🔴 Продвинутый**
- 🤖 Создайте новые функции ИИ
- ⚙️ [Улучшения основного движка](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Acore)
- 🔐 [Функции безопасности](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Asecurity)
...
Свяжитесь с разработчиками, получите помощь и будьте в курсе последних разработок Học cùng Royce!
...
<p align="center">
  <a href="https://trannhuy.online">Веб-сайт</a> |
  <a href="https://github.com/ROYCE-8425/quiz_study/blob/main/docs/development/build-from-source.md">Документация</a> |
  <a href="https://github.com/ROYCE-8425/quiz_study/discussions">Обсуждения</a> |
...
<p align="center">
  <strong>Создано с ❤️ сообществом <a href="https://github.com/hoc-cung-royce">Học cùng Royce</a></strong>
</p>
