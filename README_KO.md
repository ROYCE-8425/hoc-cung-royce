...
<p align="center">
  <a href="https://github.com/ROYCE-8425/quiz_study/blob/main/docs/development/build-from-source.md">문서</a> |
  <a href="#빠른-시작">빠른 시작</a> |
  <a href="https://github.com/ROYCE-8425/quiz_study/discussions">토론</a> |
...
## Học cùng Royce란 무엇인가요?

Học cùng Royce는 개인화된 콘텐츠, 지능형 튜터링, 적응형 평가를 통해 학생들이 더 효과적으로 학습할 수 있도록 돕는 **오픈 소스 AI 기반 학습 플랫폼**입니다. 학생, 교육자, 평생 학습자를 위해 구축된 Học cùng Royce는 최첨단 AI 기술과 검증된 학습 과학을 결합합니다.

콘텐츠 전달에만 집중하는 전통적인 학습 플랫폼이나 포괄적인 학습 기능이 부족한 AI 튜터링 도구와 달리, Học cùng Royce는 6개의 강력한 AI 기능, 완전한 학습 도구 키트, 멀티 플랫폼 액세스를 갖춘 완전한 학습 생태계를 제공합니다.

<p align="center">
  <img src=".github/screenshots/dashboard-home.png" alt="Học cùng Royce Dashboard" width="800">
  <br>
  <em>Học cùng Royce의 AI 기반 학습 대시보드</em>
</p>
...
<p align="center">
  <img src=".github/screenshots/ai-chat.png" alt="Học cùng Royce AI 채팅" width="800">
  <br>
...
## 왜 Học cùng Royce인가? (비교)

| 기능 | Học cùng Royce | Quizlet | Anki | ChatGPT | Khan Academy |
|---------|-----------|---------|------|---------|--------------|
| **시험 복제** | ✅ AI 생성 | ❌ | ❌ | ❌ | ❌ |
...
<p align="center">
  <img src=".github/screenshots/problem-solver.png" alt="Học cùng Royce 멀티 에이전트 문제 해결사" width="800">
  <br>
  <em>멀티 에이전트 문제 해결사 -- 분석, 해결, 검증 에이전트가 실시간으로 협력하여 복잡한 문제를 분해하고 검증</em>
</p>

### Học cùng Royce의 독특한 점은 무엇인가요?
...
Học cùng Royce는 성장하는 커뮤니티가 있는 **적극적으로 유지 관리되는** 프로젝트입니다. 현재 상황은 다음과 같습니다:
...
| 지표 | 상태 | 세부 정보 |
|--------|--------|---------|
| **총 기여자 수** | ![Contributors](https://img.shields.io/github/contributors/ROYCE-8425/quiz_study?style=flat-square) | 성장하는 개발자 커뮤니티 |
| **총 커밋 수** | ![Commits](https://img.shields.io/github/commit-activity/t/ROYCE-8425/quiz_study?style=flat-square) | 2024년 이후 활발한 개발 |
| **월간 커밋 수** | ![Commit Activity](https://img.shields.io/github/commit-activity/m/ROYCE-8425/quiz_study?style=flat-square) | 정기적인 업데이트 및 개선 |
...
| **테스트 커버리지** | ![Coverage](https://img.shields.io/badge/coverage-planned-blue?style=flat-square) | 백엔드 단위 + 통합 테스트 |
...
Học cùng Royce는 i18next(프론트엔드) 및 Easy Localization(모바일)을 통해 12개 언어를 지원합니다:
...
## 🚀 왜 Học cùng Royce에 기여해야 하나요?

Học cùng Royce는 단순한 또 다른 오픈 소스 프로젝트가 아닙니다 -- AI 기반 교육의 미래를 구축하고 전 세계 수백만 명의 학생들에게 양질의 학습을 제공할 수 있는 기회입니다.
...
💡 **아이디어가 있나요?** [GitHub 토론](https://github.com/ROYCE-8425/quiz_study/discussions)을 열거나 기존 스레드에 기여하세요
...
**이게 전부입니다!** 이제 Học cùng Royce가 로컬에서 실행되고 있습니다.
...
**🟢 초보자 친화적**
- 📝 [오타 수정 또는 문서 개선](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Adocumentation)
- 🌍 [번역 추가](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Ai18n) -- 12개 언어 지원
- 🐛 [간단한 버그 수정](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
- ✨ [UI/UX 개선](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Aui%2Fux)

**🟡 중급**
- 🔌 새로운 AI 에이전트 도구 또는 기능 추가
- 📊 분석 대시보드 및 시각화 개선
- 🧪 [테스트 작성](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Atesting)
- 🚀 [성능 개선](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Aperformance)

**🔴 고급**
- 🤖 새로운 AI 기능 구축 (멀티모달 입력, 고급 추론)
- ⚙️ [핵심 엔진 개선](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Acore)
- 🏗️ [아키텍처 개선](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Aarchitecture)
- 🔐 [보안 기능](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Asecurity)
...
❓ **질문하기** -- 막히면 [토론](https://github.com/ROYCE-8425/quiz_study/discussions)에 참여하세요
...
- 💬 [GitHub 토론](https://github.com/ROYCE-8425/quiz_study/discussions) -- 질문하기, 아이디어 공유
- 💬 [Discord Community](https://discord.gg/9JEk6WSM) -- Join our Discord server
- 📖 [기여 가이드](CONTRIBUTING.md) -- 자세한 기여 가이드라인
- 🐛 [GitHub Issues](https://github.com/ROYCE-8425/quiz_study/issues) -- 버그 보고 또는 기능 요청
- 📧 [이메일](mailto:trannhuy8425@gmail.com) -- 유지 관리자에게 직접 연락
...
**기여 방법:**
- [GitHub Issues](https://github.com/ROYCE-8425/quiz_study/issues)를 통해 버그 보고 또는 기능 요청
...
Học cùng Royce에 기여해 주신 모든 멋진 분들께 감사드립니다! 🎉
...
개발자와 연결하고, 도움을 받고, Học cùng Royce의 최신 개발에 대한 최신 정보를 받으세요!
...
| 플랫폼 | 목적 | 링크 |
|----------|---------|------|
| 💡 **GitHub 토론** | 질문하기, 아이디어 공유, 기능 요청 | [토론 시작](https://github.com/ROYCE-8425/quiz_study/discussions) |
| 💬 **Discord** | 커뮤니티 참여, 실시간 채팅 | [Discord 참여](https://discord.gg/9JEk6WSM) |
| 🐦 **Twitter/X** | 제품 업데이트, 공지, 팁 | [@ROYCE-8425](https://github.com/ROYCE-8425) |
| 📧 **이메일** | 유지 관리자에게 직접 연락 | trannhuy8425@gmail.com |
| 🌐 **웹사이트** | 문서, 가이드, 블로그 | [trannhuy.online](https://trannhuy.online) |
...
<p align="center">
  <a href="https://trannhuy.online">웹사이트</a> |
  <a href="https://github.com/ROYCE-8425/quiz_study/blob/main/docs/development/build-from-source.md">문서</a> |
  <a href="https://github.com/ROYCE-8425/quiz_study/discussions">토론</a> |
...
<p align="center">
  <strong><a href="https://github.com/hoc-cung-royce">Học cùng Royce</a> 커뮤니티가 ❤️로 구축</strong>
</p>
