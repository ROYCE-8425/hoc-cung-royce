...
<p align="center">
  <a href="https://github.com/ROYCE-8425/quiz_study/blob/main/docs/development/build-from-source.md">文档</a> |
  <a href="#快速开始">快速开始</a> |
  <a href="https://github.com/ROYCE-8425/quiz_study/discussions">讨论区</a> |
...
Học cùng Royce是一个**开源AI驱动的学习平台**，通过个性化内容、智能辅导和自适应评估帮助学生更有效地学习。为学生、教育工作者和终身学习者而构建，Học cùng Royce结合了尖端AI技术和经过验证的学习科学。

与仅专注于内容交付的传统学习平台或缺乏全面学习功能的AI辅导工具不同，Học cùng Royce为您提供了一个完整的学习生态系统，拥有6个强大的AI功能、完整的学习工具包和多平台访问。

<p align="center">
  <img src=".github/screenshots/dashboard-home.png" alt="Học cùng Royce Dashboard" width="800">
  <br>
  <em>Học cùng Royce的AI驱动学习仪表板</em>
</p>
...
<p align="center">
  <img src=".github/screenshots/ai-chat.png" alt="Học cùng Royce AI 聊天" width="800">
  <br>
...
## 为什么选择Học cùng Royce？（对比）

| 功能 | Học cùng Royce | Quizlet | Anki | ChatGPT | Khan Academy |
|---------|-----------|---------|------|---------|--------------|
| **考试克隆** | ✅ AI生成 | ❌ | ❌ | ❌ | ❌ |
...
<p align="center">
  <img src=".github/screenshots/problem-solver.png" alt="Học cùng Royce 多代理问题解决器" width="800">
  <br>
  <em>多代理问题解决器 -- 分析、解决和验证代理实时协作，分解并验证复杂问题</em>
</p>

### Học cùng Royce的独特之处是什么？
...
Học cùng Royce是一个**积极维护**的项目，拥有不断增长的社区。以下是正在发生的事情：
...
| 指标 | 状态 | 详情 |
|--------|--------|---------|
| **总贡献者数** | ![Contributors](https://img.shields.io/github/contributors/ROYCE-8425/quiz_study?style=flat-square) | 不断增长的开发者社区 |
| **总提交数** | ![Commits](https://img.shields.io/github/commit-activity/t/ROYCE-8425/quiz_study?style=flat-square) | 自2024年以来的积极开发 |
| **月度提交数** | ![Commit Activity](https://img.shields.io/github/commit-activity/m/ROYCE-8425/quiz_study?style=flat-square) | 定期更新和改进 |
...
| **测试覆盖率** | ![Coverage](https://img.shields.io/badge/coverage-planned-blue?style=flat-square) | 后端单元 + 集成测试 |
...
Học cùng Royce通过i18next（前端）和Easy Localization（移动）支持12种语言：
...
## 🚀 为什么要为Học cùng Royce做贡献？

Học cùng Royce不仅仅是另一个开源项目 -- 这是一个构建AI驱动教育未来并让全球数百万学生获得优质学习的机会。
...
💡 **有想法吗？** 打开[GitHub讨论](https://github.com/ROYCE-8425/quiz_study/discussions)或为现有主题做出贡献
...
**🟢 适合初学者**
- 📝 [修复拼写错误或改进文档](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Adocumentation)
- 🌍 [添加翻译](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Ai18n) -- 我们支持12种语言
- 🐛 [修复简单的错误](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
- ✨ [改进UI/UX](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Aui%2Fux)

**🟡 中级**
- 🔌 添加新的AI代理工具或功能
- 📊 改进分析仪表板和可视化
- 🧪 [编写测试](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Atesting)
- 🚀 [性能改进](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Aperformance)

**🔴 高级**
- 🤖 构建新的AI功能（多模态输入、高级推理）
- ⚙️ [核心引擎增强](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Acore)
- 🏗️ [架构改进](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Aarchitecture)
- 🔐 [安全功能](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Asecurity)
...
❓ **提问** -- 如果遇到困难，请加入我们的[讨论](https://github.com/ROYCE-8425/quiz_study/discussions)
...
- 💬 [GitHub讨论](https://github.com/ROYCE-8425/quiz_study/discussions) -- 提问、分享想法
- 💬 [Discord社区](https://discord.gg/9JEk6WSM) -- 加入我们的Discord服务器
- 📖 [贡献指南](CONTRIBUTING.md) -- 详细的贡献指南
- 🐛 [GitHub Issues](https://github.com/ROYCE-8425/quiz_study/issues) -- 报告错误或请求功能
- 📧 [电子邮件](mailto:trannhuy8425@gmail.com) -- 直接联系维护者
...
**贡献方式：**
- 通过[GitHub Issues](https://github.com/ROYCE-8425/quiz_study/issues)报告错误或请求功能
- 提交错误修复或新功能的拉取请求
- 改进文档
- 添加翻译（我们支持12种语言）
...
| 平台 | 目的 | 链接 |
|----------|---------|------|
| 💡 **GitHub讨论** | 提问、分享想法、功能请求 | [开始讨论](https://github.com/ROYCE-8425/quiz_study/discussions) |
| 💬 **Discord** | 加入我们的社区，实时聊天 | [加入Discord](https://discord.gg/9JEk6WSM) |
| 🐦 **Twitter/X** | 产品更新、公告、提示 | [@ROYCE-8425](https://github.com/ROYCE-8425) |
| 📧 **电子邮件** | 直接联系维护者 | trannhuy8425@gmail.com |
| 🌐 **网站** | 文档、指南、博客 | [trannhuy.online](https://trannhuy.online) |
...
<p align="center">
  <a href="https://trannhuy.online">网站</a> |
  <a href="https://github.com/ROYCE-8425/quiz_study/blob/main/docs/development/build-from-source.md">文档</a> |
  <a href="https://github.com/ROYCE-8425/quiz_study/discussions">讨论</a> |
...
<p align="center">
  <strong>由<a href="https://github.com/hoc-cung-royce">Học cùng Royce</a>社区倾情打造❤️</strong>
</p>
