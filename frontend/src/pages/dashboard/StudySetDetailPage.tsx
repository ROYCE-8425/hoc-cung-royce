  ...
  return (
    <DashboardLayout>
      <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              <div className="flex items-center gap-4">
                {currentStudySet.coverImageUrl ? (
                  ...
                  <div className="w-16 h-16 rounded-xl bg-green-500/10 flex items-center justify-center shrink-0">
                    <Library className="w-8 h-8 text-green-500" />
                  </div>
                )}
                <div className="min-w-0">
                  <h1 className="text-xl md:text-2xl font-bold break-words">{currentStudySet.title}</h1>
        ...
        {/* Tabs */}
        <div className="flex gap-1 border-b border-border mb-6 overflow-x-auto whitespace-nowrap scrollbar-none">
          {tabs.map((tab) => (
            <button
              key={tab.key}
