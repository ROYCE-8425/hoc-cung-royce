...
<p align="center">
  <a href="https://github.com/ROYCE-8425/quiz_study/blob/main/docs/development/build-from-source.md">ドキュメント</a> |
  <a href="#クイックスタート">クイックスタート</a> |
  <a href="https://github.com/ROYCE-8425/quiz_study/discussions">ディスカッション</a> |
...
Học cùng Royceは、パーソナライズされたコンテンツ、インテリジェントな個別指導、適応型評価を通じて、学生がより効果的に学習できるよう支援する**オープンソースのAI搭載学習プラットフォーム**です。学生、教育者、生涯学習者向けに構築されたHọc cùng Royceは、最先端のAI技術と実証済みの学習科学を組み合わせています。

コンテンツ配信のみに焦点を当てた従来の学習プラットフォームや、包括的な学習機能を欠くAI個別指導ツールとは異なり、Học cùng Royceは6つの強力なAI機能、完全な学習ツールキット、マルチプラットフォームアクセスを備えた完全な学習エコシステムを提供します。

<p align="center">
  <img src=".github/screenshots/dashboard-home.png" alt="Học cùng Royce Dashboard" width="800">
  <br>
  <em>Học cùng RoyceのAI搭載学習ダッシュボード</em>
</p>
...
<p align="center">
  <img src=".github/screenshots/ai-chat.png" alt="Học cùng Royce AIチャット" width="800">
  <br>
...
## なぜHọc cùng Royceか？（比較）

| 機能 | Học cùng Royce | Quizlet | Anki | ChatGPT | Khan Academy |
|---------|-----------|---------|------|---------|--------------|
| **試験クローン** | ✅ AI生成 | ❌ | ❌ | ❌ | ❌ |
...
<p align="center">
  <img src=".github/screenshots/problem-solver.png" alt="Học cùng Royce マルチエージェント問題解決ツール" width="800">
  <br>
  <em>マルチエージェント問題解決ツール -- 分析、解決、検証エージェントがリアルタイムで連携し、複雑な問題を分解・検証</em>
</p>

### Học cùng Royceのユニークな点は？
...
Học cùng Royceは**積極的にメンテナンスされている**プロジェクトで、成長しているコミュニティがあります。現在の状況は以下の通りです：
...
| メトリック | ステータス | 詳細 |
|--------|--------|---------|
| **総コントリビューター数** | ![Contributors](https://img.shields.io/github/contributors/ROYCE-8425/quiz_study?style=flat-square) | 成長中の開発者コミュニティ |
| **総コミット数** | ![Commits](https://img.shields.io/github/commit-activity/t/ROYCE-8425/quiz_study?style=flat-square) | 2024年以降のアクティブな開発 |
| **月間コミット数** | ![Commit Activity](https://img.shields.io/github/commit-activity/m/ROYCE-8425/quiz_study?style=flat-square) | 定期的な更新と改善 |
...
| **テストカバレッジ** | ![Coverage](https://img.shields.io/badge/coverage-planned-blue?style=flat-square) | バックエンドユニット + 統合テスト |
...
Học cùng Royceはi18next（フロントエンド）とEasy Localization（モバイル）を介して12言語をサポートしています：
...
## 🚀 なぜHọc cùng Royceに貢献するのか？

Học cùng Royceは単なる別のオープンソースプロジェクトではありません -- AI搭載教育の未来を構築し、世界中の数百万人の学生に質の高い学習を提供する機会です。
...
💡 **アイデアはありますか？** [GitHubディスカッション](https://github.com/ROYCE-8425/quiz_study/discussions)を開くか、既存のスレッドに貢献してください
...
**これで完了です！** Học cùng Royceがローカルで実行されています。
...
**🟢 初心者向け**
- 📝 [タイプミスを修正したり、ドキュメントを改善](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Adocumentation)
- 🌍 [翻訳を追加](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Ai18n) -- 12言語をサポート
- 🐛 [シンプルなバグを修正](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
- ✨ [UI/UXを改善](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Aui%2Fux)

**🟡 中級者向け**
- 🔌 新しいAIエージェントツールや機能を追加
- 📊 分析ダッシュボードと可視化を改善
- 🧪 [テストを書く](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Atesting)
- 🚀 [パフォーマンスの改善](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Aperformance)

**🔴 上級者向け**
- 🤖 新しいAI機能を構築（マルチモーダル入力、高度な推論）
- ⚙️ [コアエンジンの機能強化](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Acore)
- 🏗️ [アーキテクチャの改善](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Aarchitecture)
- 🔐 [セキュリティ機能](https://github.com/ROYCE-8425/quiz_study/issues?q=is%3Aissue+is%3Aopen+label%3Asecurity)
...
❓ **質問する** -- 行き詰まったら[ディスカッション](https://github.com/ROYCE-8425/quiz_study/discussions)に参加
...
- 💬 [GitHubディスカッション](https://github.com/ROYCE-8425/quiz_study/discussions) -- 質問、アイデアの共有
- 💬 [Discord Community](https://discord.gg/9JEk6WSM) -- Join our Discord server
- 📖 [コントリビューションガイド](CONTRIBUTING.md) -- 詳細なコントリビューションガイドライン
- 🐛 [GitHub Issues](https://github.com/ROYCE-8425/quiz_study/issues) -- バグ報告や機能リクエスト
- 📧 [メール](mailto:trannhuy8425@gmail.com) -- メンテナーへの直接連絡
...
**貢献方法：**
- [GitHub Issues](https://github.com/ROYCE-8425/quiz_study/issues)でバグを報告したり、機能をリクエスト
- バグ修正や新機能のプルリクエストを送信
- ドキュメントを改善
- 翻訳を追加（12言語をサポート）
...
Học cùng Royceに貢献してくれたすべての素晴らしい人々に感謝します！🎉
...
開発者とつながり、ヘルプを得て、Học cùng Royceの最新の開発について最新情報を入手してください！
...
| プラットフォーム | 目的 | リンク |
|----------|---------|------|
| 💡 **GitHubディスカッション** | 質問、アイデアの共有、機能リクエスト | [ディスカッションを開始](https://github.com/ROYCE-8425/quiz_study/discussions) |
| 💬 **Discord** | コミュニティに参加、リアルタイムチャット | [Discordに参加](https://discord.gg/9JEk6WSM) |
| 🐦 **Twitter/X** | 製品アップデート、お知らせ、ヒント | [@ROYCE-8425](https://github.com/ROYCE-8425) |
| 📧 **メール** | メンテナーへの直接連絡 | trannhuy8425@gmail.com |
| 🌐 **ウェブサイト** | ドキュメント、ガイド、ブログ | [trannhuy.online](https://trannhuy.online) |
...
<p align="center">
  <a href="https://trannhuy.online">ウェブサイト</a> |
  <a href="https://github.com/ROYCE-8425/quiz_study/blob/main/docs/development/build-from-source.md">ドキュメント</a> |
  <a href="https://github.com/ROYCE-8425/quiz_study/discussions">ディスカッション</a> |
...
<p align="center">
  <strong><a href="https://github.com/hoc-cung-royce">Học cùng Royce</a>コミュニティによって❤️で構築</strong>
</p>
